...
public class SimpleList {
	...
	/**
	 * SimpleList constructor initializes the list of integers and sets the count to
	 * zero.
	 */
	public SimpleList() {
		list = new int[10];
	...
	/**
	 * Adds the number N to the zeroth index of the array of integers and shifts the
	 * rest by one so the new element is always at the zeroth index just like in a
	 * stack.
	 * 
	...
	/**
	 * Removes an item from the list. Searches for the parameter value and removes
